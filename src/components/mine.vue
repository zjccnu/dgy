					...
					<div class="mui-scroll">
						...
						<div>
									<ul class="mui-table-view mui-grid-view mui-grid-9" style="background: #FFFFFF;">
							            ...
							            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><a href="#">
							            		<span class="mui-icon mui-icon-home"></span>
							                    <div class="mui-media-body">产品</div></a></li>
							            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><a href="#">
							                    <span class="mui-icon mui-icon-chatbubble"></span>
							                    <div class="mui-media-body">公告</div></a></li>
							            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><a href="#">
							                    <span class="mui-icon mui-icon-location"></span>
							                    <div class="mui-media-body">考勤</div></a></li>
							            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3" @click="check()"><a href="#">
							                    <span class="mui-icon mui-icon-search"></span>
							                    <div class="mui-media-body">审批</div></a></li>
							            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><a href="#">
							                    <span class="mui-icon mui-icon-phone"></span>
							                    <div class="mui-media-body">日志</div></a></li>
							            <li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-3"><a href="#">
							                    <span class="mui-icon mui-icon-gear"></span>
							                    <div class="mui-media-body">拜访线路</div></a></li>
							        </ul> 
						</div>
						<ul class="mui-table-view mui-table-view-chevron">
...
<script>
    ...
    import mview from    '../assets/common/js/mui.view.js'
    import feedback from '../assets/common/js/feedback.js'
	export default({
		name:'customList',
		data(){
			return {
		...
		function shareMessage(share, ex) {
			...
			msg.thumbs = ["../assets/common/images/logo.png"];
		...
		function defaultImg() {
			if(mui.os.plus){
				plus.io.resolveLocalFileSystemURL("_doc/head.jpg", function(entry) {
					...
					document.getElementById("head-img").src = '../assets/common/images/logo.png';
					document.getElementById("head-img1").src = '../assets/common/images/logo.png';
				})
			}else{
				document.getElementById("head-img").src = '../assets/common/images/logo.png';
				document.getElementById("head-img1").src = '../assets/common/images/logo.png';
